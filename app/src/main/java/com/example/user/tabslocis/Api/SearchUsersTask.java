...
import com.example.user.tabslocis.SearchUsersActivity;
...
public class SearchUsersTask extends AsyncTask {
    ...
    protected Object doInBackground(Object[] params) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                friends.add(new ItemFriend(name,id));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void onPostExecute(Object o) {
        ...
        else activity.onJSONParsed(friends=new ArrayList<ItemFriend>());
    }
}
